...
function Sponsor() {
  ...
  return (
    <div className="max-w-6xl mx-auto p-6 bg-white rounded-lg shadow-lg">
      {/* Top Section: My List Button */}
      <div className="flex justify-between items-center mb-4">
        <h1 className="text-2xl font-bold text-blue-600">Are You Interested to Sponsor An Event?</h1>
        <button
          onClick={() => navigate('/my-sponsor-list')} // Navigate to MySponsorList page
